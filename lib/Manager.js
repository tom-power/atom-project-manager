...
export class Manager {
  ...
  @action removeProject(props) {
    ...
    this.projects = this.projects.filter(item => item !== foundProject)
  }
  ...
  deleteProject(props) {
    let propsToRemove = props;
    if (Manager.isProject(props)) {
      propsToRemove = props.getProps();
    }
    this.removeProject({ ...propsToRemove, source: 'file' });
    this.saveProjects();
  }
